...

{
    ...
    private Page5.CandidateAdapter mCandidateAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn2.setOnClickListener(Page5.this);
        mCandidateAdapter = new Page5.CandidateAdapter(this);
    ...
    public void onCandidateButtonClick(View v) {
        Page5.CandidateTag tag = (Page5.CandidateTag) v.getTag();
        if (tag != null) {
...
//    updateCandidatePanel();
    ...
    private class CandidateAdapter extends BaseAdapter {
        ...
        private List<Page5.CandidateTag> mCandidates;
        ...
        public void setCandidates(List<Page5.CandidateTag> candidates) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Page5.CandidateTag tag = mCandidates.get(position);
            b.setTag(tag);
...
//      Button b = (Button) mCandidateBar.getChildAt(i);
            ...
            Page5.CandidateTag tag = new Page5.CandidateTag();
            if (i < labels.size()) {
                tag.start = start;
                tag.end = end;
    ...
    private void updateCandidatePanel() {
        ...
        List<Page5.CandidateTag> candidates = new ArrayList<>();
