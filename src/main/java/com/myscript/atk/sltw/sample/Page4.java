...

{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCandidateAdapter = new Page4.CandidateAdapter(this);
        ...
        btn1.setOnClickListener(Page4.this);
    ...
    public void onCandidateButtonClick(View v) {
        Page4.CandidateTag tag = (Page4.CandidateTag) v.getTag();
        if (tag != null) {
...
//    updateCandidatePanel();
    ...
    private class CandidateAdapter extends BaseAdapter {
        ...
        private List<Page4.CandidateTag> mCandidates;
        ...
        public void setCandidates(List<Page4.CandidateTag> candidates) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Page4.CandidateTag tag = mCandidates.get(position);
            b.setTag(tag);
...
//      Button b = (Button) mCandidateBar.getChildAt(i);
            ...
            Page4.CandidateTag tag = new Page4.CandidateTag();
            if (i < labels.size()) {
                tag.start = start;
                tag.end = end;
    ...
    private void updateCandidatePanel() {
        ...
        List<Page4.CandidateTag> candidates = new ArrayList<>();
